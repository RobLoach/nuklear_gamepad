...
NK_API struct nk_gamepad_input_source nk_gamepad_pntr_input_source(void* user_data);
...
int nk_gamepad_pntr_map_button(int button) {
    switch (button) {
        ...
        case NK_GAMEPAD_BUTTON_L2: return PNTR_APP_GAMEPAD_BUTTON_LEFT_TRIGGER;
        case NK_GAMEPAD_BUTTON_R2: return PNTR_APP_GAMEPAD_BUTTON_RIGHT_TRIGGER;
        case NK_GAMEPAD_BUTTON_L3: return PNTR_APP_GAMEPAD_BUTTON_LEFT_THUMB;
        case NK_GAMEPAD_BUTTON_R3: return PNTR_APP_GAMEPAD_BUTTON_RIGHT_THUMB;
